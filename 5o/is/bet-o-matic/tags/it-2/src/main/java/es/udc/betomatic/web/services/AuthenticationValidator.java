...
public class AuthenticationValidator {
	...
	private final static String ERROR_PAGE = "error/AuthenticationError";

	public static final String PAGE_AUTHENTICATION_TYPE = "betomatic.page-authentication-type";
	public static final String EVENT_HANDLER_AUTHENTICATION_TYPE = "betomatic.event-handler-authentication-type";
