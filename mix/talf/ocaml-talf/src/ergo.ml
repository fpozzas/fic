...
(*****************************************************************************
 *
 * ergo.ml   Funciones de conversi�n desde string o file para los tipos de   
 *           auto.ml.                                                        
 *
 *****************************************************************************)
 ...
 *
 * Funci�n que dado un string y una lista de s�mbolos especiales, devuelve
 * el mismo string pero cambiando cada una de las apariciones de los s�mbolos
 * especiales por su versi�n "escapada", es decir, precedido por el s�mbolo \.
 *
 *****************************************************************************)
      ...
      let rec aux lc llc n =
         if n < 0 then
            let rec aux2 ns i = function
                 [] -> ns
               | c::t -> ns.[i] <- c; aux2 ns (i+1) t
            in
               aux2 (String.create llc) 0 lc
         else
 ...
 *
 * Funci�n que dado un string devuelve la lista de s�mbolos correspondiente, 
 * y viceversa.                                                              
 *
 *****************************************************************************)
 ...
 *
 * Funci�n que dado un nombre de fichero devuelve la lista de s�mbolos       
 ...
 *
 * Funci�n que dado un string devuelve la expresion regular correspondiente, 
 * y viceversa.                                                              
 *
 *****************************************************************************)
 ...
 *
 * Funci�n que dado un nombre de fichero devuelve la expresion regular       
 * correspondiente, y viceversa.                                             
 *
 *****************************************************************************)
 ...
 *
 * Funci�n que dado un string devuelve el aut�mata finito correspondiente,   
 * y viceversa.                                                              
 *
 *****************************************************************************)
...
let string_of_af
   ...
   in
      ...
      and aux2 = function
         ...
         | _ -> raise (Failure "string_of_af: el conjunto de s�mbolos contiene un no terminal")
      and aux3 = function
           [] -> ""
 ...
 *
 * Funci�n que dado un nombre de fichero devuelve el aut�mata finito         
 * correspondiente, y viceversa.                                             
 *
 *****************************************************************************)
 ...
 *
 * Funci�n que dado un string devuelve la gram�tica independiente del        
     ...
     Gic (Conjunto no_terminales, Conjunto terminales, Conjunto reglas, No_terminal axioma) ->
        ...
        in
           let rec aux1 = function
              ...
              | _ -> raise (Failure "string_of_gic: el conjunto de s�mbolos no_terminales contiene un terminal")
           and aux2 = function
                [] -> ""
              | [Terminal s] -> incluir_escape s esp
              | Terminal s :: t -> (incluir_escape s esp) ^ " " ^ (aux2 t)
              | _ -> raise (Failure "string_of_gic: el conjunto de s�mbolos terminales contiene un no terminal")
           and aux3 = function
                [] -> ""
 ...
 *
 * Funci�n que dado un nombre de fichero devuelve la gram�tica independiente 
 ...
 *
 * Funci�n que dado un string devuelve el aut�mata de pila correspondiente,   
 * y viceversa.                                                              
 *
 *****************************************************************************)
...
let string_of_ap
   ...
   in
      ...
      and aux2 = function
         ...
         | [Terminal s] -> incluir_escape s esp
         | Terminal s :: t -> (incluir_escape s esp) ^ " " ^ (aux2 t)
         | _ -> raise (Failure "string_of_ap: el conjunto de s�mbolos contiene un no terminal")
      and aux3 = function
           [] -> "epsilon"
         | [Terminal s] -> incluir_escape s esp
         | [No_terminal ""] -> "zeta"
 ...
 *
 * Funci�n que dado un nombre de fichero devuelve el aut�mata de pila         
 * correspondiente, y viceversa.                                             
 *
 *****************************************************************************)
 ...
 *
 * Funci�n que dado un string devuelve la m�quina de Turing correspondiente,   
 * y viceversa.                                                              
 *
 *****************************************************************************)
...
let string_of_mt
   ...
   in
      ...
      and aux2 = function
         ...
         | [Terminal s] -> incluir_escape s esp
         | Terminal s :: t -> (incluir_escape s esp) ^ " " ^ (aux2 t)
         | _ -> raise (Failure "string_of_mt: el conjunto de s�mbolos contiene un no terminal")
      and aux3 = function
           [] -> ""
         | [Terminal s] -> incluir_escape s esp
         | [No_terminal ""] -> "blanco"
 ...
 *
 * Funci�n que dado un nombre de fichero devuelve la m�quina de Turing
 * correspondiente, y viceversa.                                             
 *
 *****************************************************************************)
