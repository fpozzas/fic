...
let setup _ = Env.add (Env.add (Env.add Env.empty "x" (Env.Int(4))) "y" (Env.Int(10))) "z" (Env.Int(3))
...
let test_aexp_array env = assert_equal 9 (Eval.aexp (Env.add env "a" (Env.ArrayInt[(0,6);(1,3);(2,9);(3,1)])) (Lector.aexp "a[2]"))
...
let test_bexp_array env = assert_equal false (Eval.bexp (Env.add env "b" (Env.ArrayBool[(0,true);(1,true);(2,false);(3,true)])) (Lector.bexp "b[2]"))
...
let test_sexp_concat_2 = fun _ -> assert_equal "holitaholita" (Eval.sexp (Env.add Env.empty "a" (Env.String("holita"))) (Lector.sexp "a ^ a"))
let test_sexp_substring_1 = fun _ -> assert_equal "holi" (Eval.sexp (Env.add Env.empty "a" (Env.String("holita"))) (Lector.sexp "substring(a, 0, 4)"))
let test_sexp_substring_2 = fun _ -> assert_equal "ho" (Eval.sexp (Env.add Env.empty "a" (Env.String("holita"))) (Lector.sexp "substring(a, 0, 2)"))
let test_sexp_array env = assert_equal "b" (Eval.sexp (Env.add env "c" (Env.ArrayString[(0,"a");(1,"b");(2,"c");(3,"d")])) (Lector.sexp "c[1]"))
...
let test_comm_mkvar = fun _ -> assert_equal (Env.add Env.empty "x" (Env.Int(4))) (Eval.comm Env.empty (Lector.fichero "casos_de_prueba/mkvar.imp"))
let test_comm_mkarray_1 = fun _ -> assert_equal (Env.add Env.empty "a" (Env.ArrayInt[(0,4);(1,4);(2,5);(3,4)])) (Eval.comm Env.empty (Lector.fichero "casos_de_prueba/mkarray_1.imp"))
let test_comm_mkarray_2 = fun _ -> assert_equal (Env.add Env.empty "a" (Env.ArrayBool[(0,true);(1,false);(2,true);(3,true)])) (Eval.comm Env.empty (Lector.fichero "casos_de_prueba/mkarray_2.imp"))
let test_comm_assignarray_1 = fun _ -> assert_equal (Env.add Env.empty "a" (Env.ArrayInt[(0,9);(1,8);(2,7);(3,6)])) (Eval.comm Env.empty (Lector.fichero "casos_de_prueba/assignarray_1.imp"))
let test_comm_assignarray_2 = fun _ -> assert_equal (Env.add Env.empty "a" (Env.ArrayBool[(0,true);(1,false);(2,true);(3,true)])) (Eval.comm Env.empty (Lector.fichero "casos_de_prueba/assignarray_2.imp"))
let test_comm_assign_1 env = assert_equal (Env.add env "x" (Env.Int(13))) (Eval.comm env (Lector.fichero "casos_de_prueba/assign_2.imp"))
let test_comm_assign_2 env = assert_equal (Env.add env "x" (Env.Int(13))) (Eval.comm env (Lector.fichero "casos_de_prueba/assign_2.imp"))
let test_comm_seq env = assert_equal env (Eval.comm Env.empty (Lector.fichero "casos_de_prueba/seq.imp"))
let test_comm_if_1 = fun _ -> assert_equal (Env.add Env.empty "x" (Env.Int(5))) (Eval.comm Env.empty (Lector.fichero "casos_de_prueba/if_1.imp"))
let test_comm_if_2 = fun _ -> assert_equal (Env.add Env.empty "x" (Env.Int(9))) (Eval.comm Env.empty (Lector.fichero "casos_de_prueba/if_2.imp"))
let test_comm_while = fun _ -> assert_equal (Env.add (Env.add Env.empty "x" (Env.Int(0))) "p" (Env.Int(10))) (Eval.comm Env.empty (Lector.fichero "casos_de_prueba/while.imp"))
let test_comm_print = fun _ -> assert_equal (Env.add Env.empty "x" (Env.Int(12))) (print_string "*** Comando print correcto si escribe el número 12 por pantalla : "; Eval.comm Env.empty (Lector.fichero "casos_de_prueba/print.imp"))
