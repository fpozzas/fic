...
(* insert_sort es casi instantanea en el caso de una lista ascendente, 
mientras que su peor caso es una descendente. merge_sort tiene buenos
tiempos en cualquier caso. quick_sort es la mejor en el caso aleatorio
pero sufre si la lista a ordenar ya está previamente ordenada. *)
